    ...
    return (
        <SRestaurantMagazineWrapper>
            <SRestaurantMagazine>
                ...
                <SThumbnailWrapper>
                    <MagazineThumbnail
                        src={Image.MagazineThumbnail1}
                        label={
                            "당신만 몰랐던 숨은 맛집 알려드릴게요 #134 - 안덕면 한라산아래첫마을 외 3곳"
                        }
                    />
                    <MagazineThumbnail
                        src={Image.MagazineThumbnail2}
                        label={
                            "당신만 몰랐던 숨은 맛집 알려드릴게요 #133 - 온수역 우방정육식당 외 4곳"
                        }
                    />
                    <MagazineThumbnail
                        src={Image.MagazineThumbnail3}
                        label={
                            "당신만 몰랐던 숨은 맛집 알려드릴게요 #132 - 인사동 인사동수제비 외 2곳"
                        }
                    />
                    <MagazineThumbnail
                        src={Image.MagazineThumbnail4}
                        label={
                            "당신만 몰랐던 숨은 맛집 알려드릴게요 #131 - 평창 정가네메밀막국수 외 2곳"
                        }
                    />
                </SThumbnailWrapper>
            </SRestaurantMagazine>
            <MoreViewWide alignOfContent={"end"} isUnder={false} />
        </SRestaurantMagazineWrapper>
    )
}
